"""
Command Line Interface for Dvh Analyzer.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="dvh-analyzer", description="Dvh Analyzer")
    ...
    if args.command == "serve":
        ...
        print(f"Starting Dvh Analyzer API server on http://{args.host}:{args.port}")
