"""
FastAPI REST API Server for Dvh Analyzer.
"""
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "dvh-analyzer", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
